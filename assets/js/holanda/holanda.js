...
selecaoholanda.addEventListener("click", MudarHolanda)

function MudarHolanda() {
    const infoTitulo = document.getElementById("infoTitulo")
    const infoDescricao = document.getElementById("infoDescricao")
    infoTitulo.innerText = "Holanda"
    infoDescricao.innerText = "A holanda (também conhecida como Paises Baixos (ou PAIS DAS TULIPA)) é uma nação localizada na europa ocidental banhada pelo 'mar do Norte' ao norte e ao oeste, o pais faz fronteira com a Bélgica ao sul e com a Alemanha no leste. Sua capital é amsterdã, Uma significativa parte de seu território foi obtida através da recuperação e preservação de terras através de um elaborado sistema de pôlderes e diques."

    const infoBandeira = document.getElementById("infoBandeira")
    const infoMapa = document.getElementById("infoMapa")
    infoBandeira.setAttribute('src', './assets/imgs/bandeira-holanda.png')
    infoMapa.setAttribute('src', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2737394.6431031507!2d4.960766734375016!3d52.01058365042069!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c609c3db87e4bb%3A0xb3a175ceffbd0a9f!2sPa%C3%ADses%20Baixos!5e1!3m2!1spt-BR!2sbr!4v1661964135507!5m2!1spt-BR!2sbr')
